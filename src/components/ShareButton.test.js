...
it("should create Email share button with monster url from api database", () => {
    // const pagina = mount(<MonsterTable {...props}/>);
    // expect(rendered.querySelector("RedditShareButton").getAttribute("url")).toBe("https://open5e.com/monsters/pekora")
    expect(rendered.find(EmailShareButton).props().url).toEqual("https://open5e.com/monsters/pekora");
})

it("should create Telegram share button with monster url from api database", () => {
    // const pagina = mount(<MonsterTable {...props}/>);
    // expect(rendered.querySelector("RedditShareButton").getAttribute("url")).toBe("https://open5e.com/monsters/pekora")
    expect(rendered.find(TelegramShareButton).props().url).toEqual("https://open5e.com/monsters/pekora");
})

it("should create Whatsapp share button with monster url from api database", () => {
    // const pagina = mount(<MonsterTable {...props}/>);
    // expect(rendered.querySelector("RedditShareButton").getAttribute("url")).toBe("https://open5e.com/monsters/pekora")
    expect(rendered.find(WhatsappShareButton).props().url).toEqual("https://open5e.com/monsters/pekora");
})